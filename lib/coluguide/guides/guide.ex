defmodule Coluguide.Guides.Guide do
  @moduledoc """
  ...
  schema "guides" do
    ...
    belongs_to :template, Coluguide.Guides.Template
    belongs_to :chapter, Coluguide.Chapters.Chapter
    ...
    has_many :steps, Coluguide.Steps.Step
    # Steps (in other Guides) which link to this Guide.
    has_many :linked_to_by, Coluguide.Steps.Step
    has_many :user_reviews, Coluguide.ReviewRecords.ReviewedGuide
