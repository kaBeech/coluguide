defmodule ColuguideWeb.Router do
  use ColuguideWeb, :router
  ...
  pipeline :browser do
    ...
    plug(:put_root_layout, html: {ColuguideWeb.Layouts, :root})
  ...
  pipeline :admin do
    plug ColuguideWeb.EnsureRolePlug, :admin
  end

  pipeline :editor do
    plug ColuguideWeb.EnsureRolePlug, :editor
  end

  pipeline :editor_or_admin do
    plug ColuguideWeb.EnsureRolePlug, [:editor, :admin]
  end
  ...
  live_session :default, on_mount: ColuguideWeb.InitAssigns do
    scope "/", ColuguideWeb do
      pipe_through :browser
  ...
  live_session :authenticated, on_mount: {ColuguideWeb.InitAssigns, :user} do
    scope "/", ColuguideWeb do
      ...
      live "/chapters/edit", ChapterLive.Index, :editor_index
      ...
      live "/reviewed_guides/edit", ReviewedGuideLive.Index, :editor_index
  ...
  # scope "/api", ColuguideWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:coluguide, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard("/dashboard", metrics: ColuguideWeb.Telemetry)
