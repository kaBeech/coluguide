defmodule ColuguideWeb.EnsureRolePlug do
  @moduledoc """
  This plug verifies that the user has a specific role.

  ## Example
    
    plug ColuguideWeb.EnsureRolePlug, [:user, :editor, :admin]

    plug ColuguideWeb.EnsureRolePlug, :admin

    plug ColuguideWeb.EnsureRolePlug, ~w(user editor admin)a
  """
  import Plug.Conn, only: [halt: 1]

  use ColuguideWeb, :verified_routes
  ...
  defp maybe_halt(_any, conn) do
    conn
    |> Controller.put_flash(:error, "Not authorized to access this page.")
