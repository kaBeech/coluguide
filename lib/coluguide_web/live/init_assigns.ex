defmodule ColuguideWeb.InitAssigns do
  @moduledoc """
  ...
  def on_mount(:default, _params, _session, socket) do
    {:cont, assign(socket, :page_title, "Coluguide")}
  end
  ...
  defp get_user(socket, session, config \\ [otp_app: :coluguide])

  defp get_user(socket, %{"coluguide_auth" => signed_token}, config) do
