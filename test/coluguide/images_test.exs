defmodule Coluguide.ImagesTest do
  use Coluguide.DataCase

  alias Coluguide.Images

  describe "images" do
    alias Coluguide.Images.Image

    import Coluguide.ImagesFixtures
    ...
    test "update_image/2 with valid data updates the image" do
      ...
      assert image.src == "some updated src"
    end
